...
version: 1.0.0
description: |
  Entfernt Merkmale von KI-generiertem Deutsch aus Texten. Verwende diesen Skill
  beim Bearbeiten oder Überprüfen von Texten, damit sie natürlicher und
  menschlicher klingen. 36 Muster, davon 13 deutschspezifisch (Nominalstil,
  Genitivketten, "jedoch"-Vermeidung von "aber", Amtsdeutsch-Formalität,
  archaic Demonstrative, sowohl-als-auch, Abstraktionswörter, aufzählende
  Absatzanfänge, Werbesprache, Füllphrasen, Hedging, Schmeichelei u.v.m.).
license: MIT
